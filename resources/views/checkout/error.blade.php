...
<section class="text-gray-700 my-10 min-h-full flex flex-col items-center justify-between">
    <article class="w-3/5 mt-12 pb-16 bg-gray-200 text-red-900 rounded border-b-4 border-red-600">
        <div class="p-6 w-full rounded-t bg-red-600 text-white  mb-16 text-center font-semibold">
