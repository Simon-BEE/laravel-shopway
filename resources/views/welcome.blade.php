            ...
            <div class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                <div class="cursor-pointer"
                    @click="
                        ...
                        $refs.productModalImg.src='{{ $reference->imagePath }}';
                ">
                    ...
                    <div class="pt-3 flex items-center justify-between">
                        <p class="">{{ ucfirst($reference->product->title) }}</p>
                    ...
                    <p class="pt-1 text-gray-800 font-bold text-xl">{{ $reference->price }}<span class="font-thin">€</span></p>
                </div>
            </div>
            @empty
